# Store listing and privacy disclosures (2.3.3)
...
- **Storage:** saves user-selected settings, favorites, sanitized runtime logs, and one local Boolean acknowledging the radar introduction. Frequent-message counts remain only in current-page memory and clear on refresh or close.
